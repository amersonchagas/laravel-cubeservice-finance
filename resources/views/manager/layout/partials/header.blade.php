<div class="page-main-header">
  <div class="main-header-right row m-0">
    <div class="main-header-left">
      <div class="logo-wrapper"><a href="{{ route('manager.index') }}"><img style="max-height: 50px" class="img-fluid" src="{{asset('custom/images/logo.png')}}" alt=""></a></div>
      <div class="dark-logo-wrapper"><a href="{{ route('manager.index') }}"><img style="max-height: 50px" class="img-fluid" src="{{asset('custom/images/logo-white.png')}}" alt=""></a></div>
      ...
      <ul class="nav-menus">
        ...
        <li class="onhover-dropdown p-0">
          <button class="btn btn-primary-light" type="button">
              <a href="{{ route('logout') }}"><i data-feather="log-out"></i>Log out</a></button>
        </li>
      </ul>
    </div>
